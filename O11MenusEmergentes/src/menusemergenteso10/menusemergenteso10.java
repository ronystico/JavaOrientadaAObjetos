 ...
 * @author Rony Stico
 */
public class menusemergenteso10 extends javax.swing.JFrame {

    /**
     * Creates new form menusemergenteso10
     */
    public menusemergenteso10() {
        initComponents();
    }
 ...
 JOptionPane.showMessageDialog(null,"Pulso el derecho");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(menusemergenteso10.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new menusemergenteso10().setVisible(true);
            }
        });
    }
