 ...
 * @author Rony Stico
 */
public class jfInteress extends javax.swing.JFrame {

    /**
     * Creates new form jfInteress
     */
    public jfInteress() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btncalcular.setIcon(new javax.swing.ImageIcon(getClass().getResource("/jFrames/Files/save.png"))); // NOI18N
        ...
        btncancelar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/jFrames/Files/exit.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jfInteress.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jfInteress().setVisible(true);
            }
        });
    }
