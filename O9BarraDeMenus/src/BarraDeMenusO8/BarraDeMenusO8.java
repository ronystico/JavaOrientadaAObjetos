 ...
 * @author Rony Stico
 */
public class BarraDeMenusO8 extends javax.swing.JFrame {

    /**
     * Creates new form BarraDeMenusO8
     */
    public BarraDeMenusO8() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BarraDeMenusO8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BarraDeMenusO8().setVisible(true);
            }
        });
    }
